...
import FooterImg from '../../assets/logof.png';
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-horizontal footer-center bg-gray-100 text-gray-black p-10 ">
                ...
                <div className='flex flex-col md:flex-row text-gray-600 font-medium gap-6'>
                    <a href='#home'>Home</a>
            ...
            <footer className="footer sm:footer-horizontal footer-center bg-[#545454] text-white p-5">
                <aside>
                    <div className='flex gap-1'>
                        <p>© {new Date().getFullYear()} </p>
                        <h1 className='text-orange-500'>Mumair</h1>
